...
export default function AuthUI({ mode }: AuthUIProps) {
  ...
  return (
    <div className="min-h-screen bg-[#F5F7F4] text-[#062E23] flex justify-center items-center font-sans relative overflow-hidden py-0">
      {/* Grid pattern matching landing page hero */}
      <div className="absolute inset-0 pointer-events-none" style={{
        backgroundImage: 'linear-gradient(rgba(6,46,35,0.06) 1px, transparent 1px), linear-gradient(90deg, rgba(6,46,35,0.06) 1px, transparent 1px)',
        backgroundSize: '60px 60px',
        maskImage: 'radial-gradient(circle at center, black 40%, transparent 120%)',
        WebkitMaskImage: 'radial-gradient(circle at center, black 40%, transparent 120%)',
      }} />
          ...
          <div className="bg-white flex flex-col items-center justify-center px-6 sm:px-8 h-full text-center">
            ...
            >
              ...
              <div className="flex items-center w-full my-3 opacity-60">
                ...
                <span className="px-3 text-xs text-[#062E23]/60 font-medium">
                  OR
                </span>
                <div className="flex-1 border-t border-[#062E23]/10"></div>
              </div>
          ...
          >
            ...
            >
              ...
              <p className="text-white/90 text-[13px] mb-6 leading-[1.6] font-medium max-w-[250px]">
                Already have an account? Login to keep connected with your
                groups.
              </p>
              <button
                onClick={() => {
            ...
            >
              ...
              <p className="text-white/90 text-[13px] mb-6 leading-[1.6] font-medium max-w-[250px]">
                Don't have an account? Sign up to start tracking shared expenses
                with us.
              </p>
              <button
                onClick={() => {
