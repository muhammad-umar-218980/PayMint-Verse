...
export default async function BalancesCard({ groupId, membersMap, currentUserId }: BalancesCardProps) {
  ...
  return (
    <div className="bg-[#151f30] border border-violet-900/20 rounded-2xl overflow-hidden h-full">
      <div className="p-5 border-b border-white/5 bg-[#0d1526]/50">
      ...
      <div className="p-5 space-y-4">
        {transactions.map((t, index) => {
          ...
          return (
            <div key={index} className="flex items-center justify-between p-4 rounded-xl bg-white/5 border border-white/5 hover:border-violet-500/20 transition-colors">
              ...
              <div className="text-right">
                ...
                {/* Placeholder for Settle Up button in Phase 7 */}
